function anchors = plot_anchors10(points,num_anchors,anchors)
    ...
    for anchor = 1:num_anchors
        plot(points(anchors(anchor),1),points(anchors(anchor),2),'o','Color',COLOURS(anchor,:),'MarkerFaceColor',COLOURS(anchor,:),'MarkerSize',10);
    end
