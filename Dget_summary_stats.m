...
% for example, link_lengths not in right units
	...
	percent_mult=100/summary_stats(i,2);
        ...
        summary_stats(i,20) = params.stats.FTOC.overall_dispersion_xrad*pixel_conv;
        summary_stats(i,21) = params.stats.FTOC.overall_dispersion_yrad*pixel_conv;
        summary_stats(i,22) = params.stats.FTOC.dispersion_xrad*pixel_conv;
        summary_stats(i,23) = params.stats.FTOC.dispersion_yrad*pixel_conv;
        summary_stats(i,24)= params.stats.FTOC.SEM_xrad*pixel_conv;
        summary_stats(i,25)= params.stats.FTOC.SEM_yrad*pixel_conv;
        summary_stats(i,26) = params.stats.FTOC.scatter_mean_in;
        summary_stats(i,27) = params.stats.FTOC.scatter_mean_out*pixel_conv;
	...
	% ordered subgraph 
        ...
        summary_stats(i,32) = params.stats.FTOC.subgraph_dispersion_xrad*pixel_conv;
        summary_stats(i,33) = params.stats.FTOC.subgraph_dispersion_yrad*pixel_conv;
        summary_stats(i,34) = params.stats.FTOC.subgraph_SEM_xrad*pixel_conv;
        summary_stats(i,35) = params.stats.FTOC.subgraph_SEM_yrad*pixel_conv;
        ...
        summary_stats(i,41) = params.stats.ect_dist_mean*pixel_conv;
        summary_stats(i,42) = params.stats.ect_dist_std*pixel_conv;
%  43,44 already in degrees
	...
	percent_mult=100/summary_stats(i,53);
        ...
        summary_stats(i,71) = params.stats.CTOF.overall_dispersion_xrad;
        summary_stats(i,72) = params.stats.CTOF.overall_dispersion_yrad;
        summary_stats(i,73) = params.stats.CTOF.dispersion_xrad;
        summary_stats(i,74) = params.stats.CTOF.dispersion_yrad;
	summary_stats(i,75) = params.stats.CTOF.SEM_xrad;
	summary_stats(i,76) = params.stats.CTOF.SEM_yrad;
        summary_stats(i,77) = params.stats.CTOF.scatter_mean_in;
        summary_stats(i,78) = params.stats.CTOF.scatter_mean_out;
	...
	% ordered subgraph & orientation
        ...
        summary_stats(i,82) = params.stats.CTOF.subgraph_dispersion_xrad;
        summary_stats(i,83) = params.stats.CTOF.subgraph_dispersion_yrad;
        summary_stats(i,84) = params.stats.CTOF.subgraph_SEM_xrad;
        summary_stats(i,85) = params.stats.CTOF.subgraph_SEM_yrad;
