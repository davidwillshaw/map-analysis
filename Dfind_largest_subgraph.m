function params = Dfind_largest_subgraph(params,direction,ectopicnodes)

%D ectopicnodes=0:  ectopics not included in subgraph for FTOC
...
%            Johannis's tail removal             NOOOOOOOO
%        active_list_of_neighbours = JpruneGridTails(active_list_of_neighbours);
    end
